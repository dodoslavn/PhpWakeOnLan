...
?>
      ...
      <tr><td>Enable PHP debug:</td><td> <form id="form_debug" target="/settings/" method="post"><input onclick="autoSubmitForm(this)" type="checkbox" id="debug" name="php_debug" value="<? echo $_SESSION['debug'] ? 'checked' : ''; ?>"><label for="debug"> (only for this session)</label><input type="hidden" name="form" value="php_debug"></form> </td></tr>
