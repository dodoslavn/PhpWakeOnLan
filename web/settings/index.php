...
<html>
  ...
  <div id="header">
    ...
    <div id="content">
      ...
      <table>
      <tr><td>WoL binary:</td><td> <form target="#" method="post"><input type="input" id="wol" name="wol_binary" value="<? echo $config->configuration->wol_binary; ?>"><label for="debug"> (only for this session)</label></form>  </td></tr>
